...
public class Helper
{
    public static DateTime CommonDate2DateTime(Date d)
    {
        return new DateTime(
    ...
    public static string CommonDate2IsoDateString(Date d)
    {
        return $"{d.Year:D4}-{d.Month:D2}-{d.Day:D2}";
    }

    public static Date DateTime2CommonDate(DateTime d)
    {
        return new Date
        {
